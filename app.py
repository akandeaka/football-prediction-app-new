...
.league{background:#e8f0fe;color:#1a73e8;padding:4px 12px;border-radius:15px;font-size:0.85em}
...
.footer{text-align:center;margin-top:40px;padding:20px;opacity:0.9}
</style>
</head>
<body>
<div class="container">
...
<div class="footer"><p>Disclaimer: Prediction tool only. Bet responsibly.</p></div>
</div>
<script>
async function load(){
try{
...
def get_rules():
    rules = [
        {"id": 1, "name": "Rule 1", "description": "Home 1.20-1.29 (not 1.25) + Away 10-16", "market": "Home Win"},
        {"id": 2, "name": "Rule 2", "description": "Home 1.30-1.38 + Away 11+", "market": "Home Win"},
        {"id": 3, "name": "Rule 3", "description": "Home 1.90-1.99", "market": "Home/Draw (1X)"},
        {"id": 4, "name": "Rule 4", "description": "Home odds within 0.05 of 1.70", "market": "Over 1.5 Goals"},
        {"id": 5, "name": "Rule 5", "description": "Draw odds within 0.3 of 3.5 + Away < Home", "market": "Over 1.5 Goals"},
        {"id": 6, "name": "Rule 6", "description": "Draw probability 30-52%", "market": "Draw"},
        {"id": 7, "name": "Rule 7", "description": "Correct score 0-0 odds 6-9", "market": "HT Under 1.5 Goals"}
    ]
